...
def data12():
    crypto_currency = 'LTC-USD'

    # start = dt.datetime(2014,1,1)
    # end = dt.datetime.now()
    # data1 = yf.download(crypto_currency,start=start, end=end)
    # print(data1)
    # data1.to_excel('C:/Users/BHAVYA NANGIA/Desktop/FIL Training bitbucket/CryptOS/home/lite.xlsx')

    data1=pd.read_excel("C:/Users/BHAVYA NANGIA/Desktop/FIL Training bitbucket/CryptOS/home/lite.xlsx")
    ...
    # print(model_json)
    # with open("C:/Users/BHAVYA NANGIA/Desktop/FIL Training bitbucket/CryptOS/home/model_lite.json", "w") as json_file:
    #     json_file.write(model_json)
    # # serialize weights to HDF5
    # model.save_weights("C:/Users/BHAVYA NANGIA/Desktop/FIL Training bitbucket/CryptOS/home/model_lite.h5")
    # print("Saved model to disk")

    json_file = open('C:/Users/BHAVYA NANGIA/Desktop/FIL Training bitbucket/CryptOS/home/model_lite.json', 'r')
    loaded_model_json = json_file.read()
    json_file.close()
    model = model_from_json(loaded_model_json)
    # load weights into new model
    model.load_weights("C:/Users/BHAVYA NANGIA/Desktop/FIL Training bitbucket/CryptOS/home/model_lite.h5")
    ...
    test_data=pd.read_excel("C:/Users/BHAVYA NANGIA/Desktop/FIL Training bitbucket/CryptOS/home/lite.xlsx")
    ...
    print(f"{future_day}th Day Litecoin Price:")
    print(prediction)
