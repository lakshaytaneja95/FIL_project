...
crypto_resolver={'Bitcoin':['data_bitc','model'],
                'Ethereum':['ethc','model_ether']}
...
def cryptoprediction(name):
    ...
    data1=pd.read_excel("C:/Users/BHAVYA NANGIA/Desktop/FIL Training bitbucket/CryptOS/home/"+k[0]+".xlsx")
    ...
    # print(model_json)
    # with open("E:\FIL-Project\CryptOS\home\model.json", "w") as json_file:
    #     json_file.write(model_json)
    # # serialize weights to HDF5
    # model.save_weights("E:\FIL-Project\CryptOS\home\model.h5")
    # print("Saved model to disk")

    json_file = open('C:/Users/BHAVYA NANGIA/Desktop/FIL Training bitbucket/CryptOS/home/'+k[1]+'.json', 'r')
    loaded_model_json = json_file.read()
    json_file.close()
    model = model_from_json(loaded_model_json)
    # load weights into new model
    model.load_weights("C:/Users/BHAVYA NANGIA/Desktop/FIL Training bitbucket/CryptOS/home/"+k[1]+".h5")
    ...
    test_data=pd.read_excel("C:/Users/BHAVYA NANGIA/Desktop/FIL Training bitbucket/CryptOS/home/data_bitc1.xlsx")
    ...
    print(f"{future_day}th Day bitcoin Price:")
    print(prediction,k)
